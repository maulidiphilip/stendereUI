      ...
      <Container className="mb-2">
        ...
        <Row>
          <h4 className="text-center">
            Services at <span className="hotel-color">MtenedereInn</span>
            <span className="gap-2">
              <FaClock className="ml-5" /> 24/7 Front Desk
            </span>
          </h4>
        </Row>
        <hr />
          ...
          <Col>
            <Card>
              <Card.Body>
                ...
                <Card.Text>
                  Stay connected with high-speed unlimited internet access.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
