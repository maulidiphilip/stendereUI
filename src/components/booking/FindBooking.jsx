      ...
      <div className="container mt-5 d-flex flex-column justify-content-center align-items-center">
        ...
        {isLoading ? (
          ...
          <div className="col-md-6 mt-4 mb-5">
            ...
            <p>Full Name: {bookingInfo.guestFullName || "N/A"}</p>
            <p>Email Address: {bookingInfo.guestEmail || "N/A"}</p>
            <p>Adults: {bookingInfo.numOfAdults || 0}</p>
            <p>Children: {bookingInfo.numOfChildren || 0}</p>
            <p>Total Guests: {bookingInfo.totalNumOfGuest || 0}</p>
